        ...
        <div>
          ...
          <div className="flex">
              <div className="relative flex items-center gap-x-4 rounded-full px-4 py-1 text-sm leading-6 text-gray-900 ring-1 ring-gray-900 bg-slate-300">
                <Link href={`https://wa.me/+50689631439/?text=Quiero%20reservar%20una%20clase%20de%20prueba%20de%20${productNameEncoded}`} target="_blank" className="flex items-center gap-x-1">
